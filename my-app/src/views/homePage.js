          ...
          <div className="homePage">
            <div className="homePage__content">
              ...
              <div className="homePage__content--section">
                ...
                <img className="homePage__content--section--backgroundImage" src={SecondImage} alt="A young lady, exploring a lush green tropical forrest whilst riding on a retro moped." height="100%" width="100%">
                </img>
